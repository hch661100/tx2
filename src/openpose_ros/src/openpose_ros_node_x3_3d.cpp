...
DEFINE_string(resolution,               "608x352",     "The image resolution (display). Use \"-1x-1\" to force the program to use the default images resolution.");
...
// OpenPose Rendering
DEFINE_double(alpha_pose,               1.0,            "Blending factor (range 0-1) for the body part rendering. 1 will show it completely, 0 will hide it.");
...
float init_roll, init_yaw, init_pitch;
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "openpose_ros_node_x3_3d");
